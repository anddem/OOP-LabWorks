...
namespace LabWork_10_Test
{
    ...
    public class CloneTest
    {
        ...
        public void ClonePlace()
        {
            ...
            //Assert
            Assert.IsTrue(clone.Name == $"Клон {place.Name}");
        }
        ...
        public void CloneRegion()
        {
            ...
            //Assert
            Assert.IsTrue(clone.Name == $"Клон {region.Name}" && clone.Population == region.Population);
        }
        ...
        {
            //Arrange
            City city = new City("Город", 10, 5);

            //Act
            City clone = (City)city.Clone();

            //Assert
            Assert.IsTrue(clone.Name == $"Клон {city.Name}" &&
                clone.Population == city.Population && clone.Houses == city.Houses);
        }
        ...
        public void CloneAddress()
        {
            ...
            //Assert
            Assert.IsTrue(clone.Name == $"Клон {address.Name}" &&
